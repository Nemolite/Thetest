...
// I ask nervous people to leave, please (joke)
...
function prepare_websocket() { // функция отправки и приема данных (websocket)
	...
	var ws = new WebSocket("ws://localhost:8081"); //создаем объект
...
function out_data() { // отображение отправляемых данных
	   ...
	   return marker_once =true; // маркер для однократного вывода данных	   
} 
...
// для работы через веб сокет нужно раскомментровать функцию prepare_websocket() 
